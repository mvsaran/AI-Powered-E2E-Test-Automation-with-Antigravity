...
└─────────────────────────────────────────────────────────────────────────────┘
        ...
        ┌───────────┼───────────┐     │     ┌───────────┼───────────┐
        ▼           ▼           ▼     ▼     ▼           ▼           ▼
    🌐 EXPLORE  📸 CAPTURE  🔍 INSPECT  📝 ARCHITECT  🛠️ BUILD  ✅ TEST  🐛 DEBUG
    App Flow   Screenshots  DOM        POM Design    Code     Run     Fix
```
...
START (Single Prompt)
  ...
  └─────────────────────────────────────────────────────────┘
       ...
       └─► 🔍 DOM Structure Analysis
           ├─ Element Selectors Identification
           ├─ Form Field Mapping
           └─ User Flow Pattern Recognition
                │
                ▼
  ┌─────────────────────────────────────────────────────────┐
  │ 🏗️  PHASE 2: ARCHITECTURE DESIGN (Autonomous)          │
  └─────────────────────────────────────────────────────────┘
                │
                ├─► 📋 Choose POM (Page Object Model)
                │
                ├─► 📐 Design 5 Page Objects:
                │   ├─ LoginPage.js
                │   ├─ ProductsPage.js
                │   ├─ CartPage.js
                │   ├─ CheckoutPage.js
                ...
                └─► 📊 Plan Test Data Structure
                    └─ testData.json
                         ...
                         ▼
  ┌─────────────────────────────────────────────────────────┐
  │ 💻 PHASE 3: CODE GENERATION (Autonomous)               │
  └─────────────────────────────────────────────────────────┘
                │
                ...
                │   └─ All 5 page classes with selectors
                │
                ├─► 🧪 Test Specification
                │   ├─ checkout-flow.cy.js
                │   └─ simple-test.cy.js
                ...
                └─► 🎛️  Support Files
                    ...
                    └─ .gitignore
                         ...
                         ▼
  ┌─────────────────────────────────────────────────────────┐
  │ ✅ PHASE 4: EXECUTION & VALIDATION (Autonomous)        │
  └─────────────────────────────────────────────────────────┘
                │
                ...
                ▼
  ┌─────────────────────────────────────────────────────────┐
  │ 🐛 PHASE 5: DEBUGGING & FIXES (Autonomous)             │
  └─────────────────────────────────────────────────────────┘
                │
                ├─► 🔍 Re-inspect DOM
